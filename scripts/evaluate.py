...
from nn_pytorch.utils.paths import MODELS_DIR, FIG_DIR, DATA_DIR
...
def main() -> None:
    ...
    # load checkpoint
    checkpoint = torch.load(MODELS_DIR/'checkpoint.pth', map_location=DEVICE)
    ...
    # plots
    save_parity_plot(y_true, y_pred, FIG_DIR/'parity.pdf')
